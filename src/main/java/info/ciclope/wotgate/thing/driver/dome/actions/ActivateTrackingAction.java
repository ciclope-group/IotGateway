...
public class ActivateTrackingAction {
    ...
    public ActivateTrackingAction(JsonObject stateProperty, Vertx vertx) {
        this.vertx = vertx;
    ...
    public void activateTracking(Message<JsonObject> message) {
    ...
    private void completeTask(long id) {
        ...
        stateProperty.put("onTracking", true);
        timerTaskMap.remove(id);
