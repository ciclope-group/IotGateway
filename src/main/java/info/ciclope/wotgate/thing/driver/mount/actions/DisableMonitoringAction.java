...
public class DisableMonitoringAction {
    ...
    public DisableMonitoringAction(JsonObject stateProperty, Vertx vertx) {
        this.vertx = vertx;
    ...
    public void disableMonitoring(Message<JsonObject> message) {
    ...
    private void completeTask(long id) {
        ...
        stateProperty.put("onMonitoring", false);
        stateProperty.put("monitoredObject", MountThing.OBJECT_NONE);
        timerTaskMap.remove(id);
