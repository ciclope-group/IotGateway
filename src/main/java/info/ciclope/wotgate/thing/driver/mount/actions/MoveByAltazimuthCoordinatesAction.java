...
public class MoveByAltazimuthCoordinatesAction {
    ...
    public MoveByAltazimuthCoordinatesAction(JsonObject stateProperty, Vertx vertx) {
        this.vertx = vertx;
    ...
    public void moveByAltazimuthCoordinates(Message<JsonObject> message) {
        ThingRequest request = new ThingRequest(message.body());
        JsonObject userData;
        try {
    ...
    private void completeTask(long id) {
        ...
        stateProperty.put("altitude", taskStorage.get(taskId).getJsonObject("inputData").getFloat("altitude"));
        stateProperty.put("azimuth", taskStorage.get(taskId).getJsonObject("inputData").getFloat("azimuth"));
        stateProperty.put("ra", taskStorage.get(taskId).getJsonObject("inputData").getFloat("altitude"));
        stateProperty.put("dec", taskStorage.get(taskId).getJsonObject("inputData").getFloat("azimuth"));
        timerTaskMap.remove(id);
