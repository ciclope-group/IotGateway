...
public class ParkAction {
    ...
    private final JsonObject parkingPosition;
    private final Map<Integer, JsonObject> taskStorage;
    private final Map<Long, Integer> timerTaskMap;
    private Integer index;

    public ParkAction(JsonObject stateProperty, JsonObject parkingPosition, Vertx vertx) {
        this.vertx = vertx;
    ...
    public void park(Message<JsonObject> message) {
        if (stateProperty.getJsonObject("position").getString("label").equals("PARKING")) {
